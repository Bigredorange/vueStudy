<template>
  <div class="sticky">
    <div class="web-wraper">
      <div class="web-wraper-text">
        <个人站点>
      </div>
    </div>
    <input type="checkbox" class="menustate">
    <div class="globalnav">
      <div class="headCon">
        <ul class="head-mobile">
          <li class="menuicon">
            <label class="menuicon-label" for="menustate">
              <span class="menuicon-bread menuicon-bred-top">
                <span class="menuicon-bread-crust menuicon-bread-crust-top"></span>
              </span>

              <span class="menuicon-bread menuicon-bred-bottom">
                <span class="menuicon-bread-crust menuicon-bread-crust-bottom"></span>
              </span>
            </label>
            <a href="#menustate" class="menuanchor">
        ...
        <div class="headBar headContent ">
          <ul>
            ...
            <li>
              ...
              <router-link to="/main/base">基础概念</router-link>
            </li>
            <li>
              <!-- <a href="/main/frame">
                <span>框架应用</span>
              </a> -->
              <router-link to="/main/frame">框架应用</router-link>
            </li>
            <li>
              <!-- <a href="/main/open">
                <span>开源站点</span>
              </a> -->
              <router-link to="/main/open">开源站点</router-link>
            </li>
            <li>
              <!-- <a href="/main/future">
                <span>前沿技术</span>
              </a> -->
              <router-link to="/main/future">前沿技术</router-link>
            </li>
            <li>
